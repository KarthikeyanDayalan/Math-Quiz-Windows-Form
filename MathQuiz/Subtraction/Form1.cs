...
namespace Subtraction
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            {
                if (Convert.ToInt32(label1.Text) - Convert.ToInt32(label2.Text) == Convert.ToInt32(textBox1.Text))
                {
                    if (count > 25)
                    {
            ...
            label1.Text = randomizer.Next(99).ToString();
            label2.Text = randomizer.Next(99).ToString();
            textBox1.Focus();
        }
    }
}
